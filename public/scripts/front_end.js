...
//create card
  const $list = $("<div>").addClass("card").attr("id", list.id);
  ...
  $("<i>").addClass("far fa-star").attr("id", "favorite").appendTo($icons);
  $("<i>").addClass("far fa-edit").appendTo($icons);
  ...
  $("<p>").attr("id", "description").text(list.description).appendTo($cardBody)
  $("<p>").attr("id", "created_by").text(list.created_by_id).appendTo($cardBody)
  $("<p>").attr("id", "collaborators").text(list.collaborators).appendTo($cardBody)
